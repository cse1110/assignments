You are well aware of StackOverflow by now. Whenever someone upvotes a post, users get points. See an imaginary (and simplified) version of the `upvote()` method.
